# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in rocco.
...
from rocco.lib import app_globals, helpers 

base_config = AppConfig()
base_config.renderers = []
base_config.prefer_toscawidgets2 = True

base_config.package = rocco
...
base_config.model = rocco.model
base_config.DBSession = rocco.model.DBSession
